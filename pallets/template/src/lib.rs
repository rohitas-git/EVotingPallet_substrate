// Description:
// Build a simple proof-of-existence application. 
// 
// Proof-of-existence is an approach to validating the authenticity and ownership of a digital object 
// by storing information about the object on the blockchain. 
